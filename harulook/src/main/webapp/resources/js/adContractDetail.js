/* 게시물 상세보기  */
function adContractDetail(msg) {
	
	console.log('adContractDetail : ',msg);
	...
	adDetailContent += '<a href='+msg.goods[0].adGoodsLink+'><img id="adGoods1Img" alt="no image" style="width: 250px; height: 250px;" onError="this.src=\'resources/files/images/defaut.jpg\';" src="'+msg.goods[0].adGoodsImg+'"></a><br><br>';
	if(msg.goods[1] != null){
	adDetailContent += '<a href='+msg.goods[1].adGoodsLink+'><img id="adGoods2Img" alt="no image" style="width: 250px; height: 250px;" onError="this.src=\'resources/files/images/defaut.jpg\';" src="'+msg.goods[1].adGoodsImg+'"></a><br>';
	}
	...
	adMainImg += '<img id="adMainImg" alt="no image" style="width: 500px; height: 500px;" onError="this.src=\'resources/files/images/defaut.jpg\';" src="'+msg.adBoard[1].adBoardImg+'"><br>';
	$('#adMainImg').html(adMainImg);
	adDetailContent += '<div style="float: right;">';
	adDetailContent += '<a href='+msg.goods[2].adGoodsLink+'><img id="adGoods1Img" alt="no image" style="width: 250px; height: 250px;" onError="this.src=\'resources/files/images/defaut.jpg\';" src="'+msg.goods[2].adGoodsImg+'"></a><br>';
	if(msg.goods[3] != null){
