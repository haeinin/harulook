...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#businessUpdateFormButton').click(function(){	//회원가입버튼
					...
					<h2 id="loginTitle">내정보수정하기</h2>
						<div class="login-box well">
							 <form id="addBusinessUpdate" action="${pageContext.request.contextPath}/addBusinessUpdate" method="post">
					            ...
					            <input name="userId" id="user_id" type="text" readonly value="${businessDetail.userId}"/>  
					            ...
					            <input name="userTel" id="user_tel" type="text" value="${businessDetail.userTel}"/>
					            ...
					            <input name="userEmail" id="user_email" type="text" value="${businessDetail.userEmail}"/>
					            ...
					            <input name="userA" id="user_a" type="text" value="${businessDetail.userA}"/>
					            ...
					            <input name="userUrl" id="user_url" type="text" value="${businessDetail.userUrl}"/>
					            ...
					            <input name="userBsNo" id="user_bs_no" type="text" value="${businessDetail.userBsNo}"/>
		            			...
		            			<!-- 관리자 사업자 수정버튼 -->
			     				<div>
						       		<input class="btn btn-default" id="businessUpdateFormButton" type="button" value="수정확인"/>
						        </div>
						        <!-- 회원탈퇴버튼 -->
						    	<div>
