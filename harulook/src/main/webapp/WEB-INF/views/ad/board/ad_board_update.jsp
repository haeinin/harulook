    ...
    <div class="row">
	    ...
	    <div id="div1" class="col-xs-9">
			...
			<select id="ad-1tempselect" >
						...
						<option value="temp30">30도 이상</option></c:if>
				<option></option>
			...
			상세제품1에 해당하는 링크<br><br>
					<input type="text" id="ad-1adGoods1Link" class="ad-1" name="adGoodsLink" value="${adgoods[0].adGoodsLink}"><br><br>
			...
			상세제품2에 해당하는 링크<br><br>
					<input type="text" id="ad-1adGoods2Link" class="ad-1" name="adGoodsLink" value="${adgoods[1].adGoodsLink}"><br><br>
					<input type="hidden"  name="adBoardTempMax" id="ad-1adBoardTempMax">
					<input type="hidden"  name="adBoardTempMin" id="ad-1adBoardTempMin">
					<input type="hidden" value="" name='adGoodsCount' id='ad1GoodsCount' value="${goodscount[0]}">
					...
					<input type="hidden" value="${adboardlist[1].adBoardNo}" name="adBoardNo">
					<br>
			게시물 설명<br><br>
					<input type="text" id="temp-5adBoardContent" name="adBoardContent" class="ad-1" value="${adboardlist[0].adBoardContent}"><br><br>
			...
			<select name="temp" id="ad-2tempselect">
				<option <c:if test="${adboardlist[1].adBoardTempMin==-100}">
						<option value="temp-5">-5도 이하</option></c:if>
			...
			상세제품1에 해당하는 링크<br><br>
					<input type="text" id="ad-2adGoods1Link" class="ad-2" name="adGoodsLink" value="${adgoods[2].adGoodsLink }"><br><br>
			상세제품2 이미지
			...
			상세제품2에 해당하는 링크<br><br>
					<input type="text" class="ad-2" name="adGoodsLink" value="${adgoods[3].adGoodsLink}"><br><br>
					...
					<input type="hidden" value="${adboardlist[3].adBoardNo}" name="adBoardNo">
					
					<br>
			게시물 설명<br><br>
					<input type="text" id="ad-2adBoardContent" name="adBoardContent" class="ad-2" value="${adboardlist[1].adBoardContent}"><br><br>
			...
			<br>
			<input type="hidden" id="adBoardCount" name="adBoardCount" value="${adboardcount}">
