...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <c:forEach var="b" items="${adcontractsoonlist}">
            <tr>
                    ...
                    <td>
                    <c:if test="${sessionScope.level=='사업자'}">
                    <c:if test="${b.adContractStat=='광고대기'}"><a class="btn btn-info" href="./adBoardUpdate?adContractNo=${b.adContractNo}">수정하기</a></c:if>
                    </c:if>
                    </td>                    
                </tr>
                </c:forEach>
